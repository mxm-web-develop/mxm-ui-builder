...
const components = [SlgBanner,SlgCoupon,SlgFooter,SlgHeader,SlgLogin,SlgPointcard,SlgRetailercard,SlgShowcase,SlgSidecontrol];

const install = (app: App) => {
  components.map((component) => app.component(component.name, component));
};

export { SlgBanner,SlgCoupon,SlgFooter,SlgHeader,SlgLogin,SlgPointcard,SlgRetailercard,SlgShowcase,SlgSidecontrol };
